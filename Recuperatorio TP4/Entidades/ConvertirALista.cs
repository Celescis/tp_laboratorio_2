    ...
    public static class ConvertirALista
    {
        public static Wiki ListaJugadoresConInventario(DataTable dt)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (!(string.IsNullOrEmpty(dr[5].ToString()) || string.IsNullOrEmpty(dr[4].ToString())))
                {
                ...
                if (!(string.IsNullOrEmpty(dr[8].ToString()) || string.IsNullOrEmpty(dr[7].ToString()) || string.IsNullOrEmpty(dr[6].ToString())))
                {
                    tool = new Herramienta((ETipoHerramienta)Enum.Parse(typeof(ETipoHerramienta), dr[8].ToString()), (ETipoMaterial)Enum.Parse(typeof(ETipoMaterial), dr[7].ToString()), int.Parse(dr[6].ToString()));
        ...
        //public static Wiki ListarInventario(DataTable dt)
        //{
        //    Inventario inv;
        //    Cubo cubo = new Cubo();
        //    Herramienta tool = new Herramienta();
